...
public class KafkaStringListener {
    ...
    @KafkaListener(topics = TOPIC, groupId = "strings-all", containerFactory = "allKafkaListenerContainerFactory")
    ...
    @KafkaListener(topicPartitions = @TopicPartition(topic = TOPIC, partitions = {"0"}), containerFactory = "partitionKafkaListenerContainerFactory")
    ...
    @KafkaListener(topics = TOPIC, groupId = "strings-filtered", containerFactory = "filterKafkaListenerContainerFactory")
