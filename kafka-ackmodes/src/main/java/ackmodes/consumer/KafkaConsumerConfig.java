...
public class KafkaConsumerConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> manualAckContainerFactory() {
        ...
        factory.setConsumerFactory(manAckConsumerFactory("names-man-ack"));
        return factory;
    }

    private ConsumerFactory<String, String> manAckConsumerFactory(final String groupId) {
        HashMap<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, false); // required for AckMode.MANUAL_IMMEDIATE
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, groupId);
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
